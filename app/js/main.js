    ...
    render: function () {
        ...
        return React.createElement(
            ...
            React.createElement(
                "div",
                { className: "row" },
                React.createElement(CardWhite, { title: "20", text: "New followers added this month" }),
                React.createElement(CardWhite, { title: "$1250", text: "Average Monthly Income" }),
                React.createElement(CardWhite, { title: "$13865", text: "yearly Income Goal" })
            ),
            React.createElement(
                "div",
                { className: "row" },
                React.createElement(CardDarkBottom, { color: "lavender" }),
                React.createElement(CardDarkBottom, { color: "CornflowerBlue" }),
                React.createElement(CardDarkBottom, { color: "yellow" })
            )
        );
    }
});
...
},{"./CardDarkBottom.jsx":164,"./CardWhite.jsx":166,"react":158}],160:[function(require,module,exports){
var React = require("react");
var CardSolid = require("./CardSolid.jsx");
var CardColorTop = require("./CardColorTop.jsx");

var BlockRight = React.createClass({
    displayName: "BlockRight",
    ...
    render: function () {
        ...
        return React.createElement(
            ...
            React.createElement(CardSolid, { title: "18", text: "Paris", color: "orange" }),
            React.createElement(CardColorTop, { title: "New Visitors", text: "1.5k", color: "cornflower" }),
            React.createElement(CardColorTop, { title: "Bounce rate", text: "58%", color: "lavender" }),
            React.createElement(CardColorTop, { title: "Searches", text: "28%", color: "tomato" }),
            React.createElement(CardColorTop, { title: "Traffic", text: "140.5kb", color: "lime" })
        );
    }
});
...
},{"./CardColorTop.jsx":163,"./CardSolid.jsx":165,"react":158}],161:[function(require,module,exports){
var React = require("react");
...
var Blocks = React.createClass({
    ...
    render: function () {
        ...
        return React.createElement(
            "div",
            { className: "row" },
            React.createElement(BlockLeft, { className: "col-sm-9 hidden-xs" }),
            React.createElement(BlockRight, { className: "col-sm-3" })
        );
    }
});
...
},{"./BlockLeft.jsx":159,"./BlockRight.jsx":160,"react":158}],162:[function(require,module,exports){
var React = require("react");

var CardBlank = React.createClass({
    displayName: "CardBlank",
...
var CardColorTop = React.createClass({
    ...
    render: function () {
        ...
        return React.createElement(
            ...
            React.createElement(
                "div",
                { style: headingStyle, className: "panel-heading text-left" },
                React.createElement(
                    "span",
                    { style: titleStyle },
                    this.props.title
...
var CardColorTop = React.createClass({
    ...
    render: function () {
        ...
        return React.createElement(
            "div",
            { style: boxStyle, className: "panel panel-primary col-sm-12" },
            React.createElement("div", { style: bodyStyle, className: "panel-body" }),
            React.createElement(
                "div",
                { style: footerStyle, className: "row panel-footer" },
                React.createElement(CardBlank, { title: "15080", text: "Shot views" }),
                React.createElement(CardBlank, { title: "12000", text: "Likes" }),
                React.createElement(CardBlank, { title: "5100", text: "Comments" })
            )
        );
    }
});
...
},{"./CardBlank.jsx":162,"react":158}],165:[function(require,module,exports){
var React = require("react");

var CardSolid = React.createClass({
    displayName: "CardSolid",
    ...
    render: function () {
        ...
        return React.createElement(
            "div",
            { style: boxStyle, className: "text-center" },
            React.createElement(
                "h2",
                null,
                this.props.title
...
var CardSolid = React.createClass({
    ...
    render: function () {
        ...
        return React.createElement(
            "div",
            { style: boxStyle, className: "col-sm-4" },
            React.createElement(
                "div",
                { style: panelStyle, className: "text-left  panel panel-default" },
                React.createElement(
                    "h4",
                    null,
                    this.props.title
...
ReactDom.render(React.createElement(Blocks, null), document.getElementById("blocks"));

},{"./components/Blocks.jsx":161,"react":158,"react-dom":2}]},{},[167]);
